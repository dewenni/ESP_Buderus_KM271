...
<head>
    ...
    <style>
        ...
        .btn2{background-color:#e29425;box-shadow:0 0 8px 0 rgba(0,0,0,0.08),0 0 15px 0 rgba(0,0,0,0.02),0 0 20px 4px rgba(0,0,0,0.06);color:#fff;border-radius:4px;padding:9px 16px;background-image:none;text-decoration:none;border:none;letter-spacing:1.25px;cursor:pointer;text-transform:uppercase;font-size:14px;line-height:18px;display:inline-block;vertical-align:middle;transition-duration:0.1s}
        ...
        .btn2:active{color:#fff;background-color:#ca7125}
        .btn2:disabled{cursor:default;background:#DDD}
        html{font-family:Roboto,Arial,sans-serif;display:inline-block;margin:0 auto;text-align:center}
        p{font-size:3.0rem;margin-top:0}
        .units{font-size:1.2rem}
        .dht-labels{font-size:1.5rem;vertical-align:middle;padding-bottom:15px;font-weight:normal;color:#333333}
    </style>
...
<head>
    ...
    <style>
      ...
      .btn2:active{color:#fff;background-color:#ca7125}
      .btn2:disabled{cursor:default;background:#DDD}
      .btndel{border:none;color:#fff;padding:0px 6px;height:25px;text-align:center;text-decoration:none;display:inline-block;font-size:14px;margin:2px 2px;cursor:pointer;border-radius:4px;background-color:#e03423db;transition-duration:0.1s}
      .btndel:hover{background-color:#b02f19}
      .btndel:visited{color:#fff}
      .btndel:active{color:#fff;background-color:#db331d}
      html {font-family: Roboto, Arial, sans-serif;display: inline-block;margin: 0px auto;text-align: center;}
      p { font-size: 3.0rem; margin-top: 0;}
      .units { font-size: 1.2rem; }
      .dht-labels{font-size: 1.5rem;vertical-align:middle;padding-bottom: 15px;font-weight: normal;color: #333333;}
      a {color: #ffffff;}
...
<body>
    <form method="POST" action="http://192.168.0.160/filesystem#" enctype="multipart/form-data" id="upload_form">
        ...
        <br><h4 style="text-align:center;">File system content:</h4>
        <span id="filelist">%list%</span>
        <br><div id="prg" style="display:none">Ready to upload</div>
        <br><div id="prgbar" style="display:none"><div id="bar"></div></div>
    </form>
    <script>
        function deletef(h) {
